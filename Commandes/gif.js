...
const pdp=require('../Storage/gif.json')
module.exports.run = async(client, message, args) => {
    const random = util.math.random(0,363)
    ...
    message.delete();
    client.channels.cache.get("791685146461863956").send(`${message.guild.name} | **${message.author.tag}** -> \`${config.prefix}gif\``)
}
module.exports.help = {
    name: "gif",
    aliases: ["anigif", "animegif", "GIF", "Gif", "Animegif", "Anigif", "AniGIF", "AnimeGIF", "AnimeGif", "AniGif"]
}
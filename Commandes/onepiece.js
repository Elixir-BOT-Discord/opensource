...
module.exports.run = async(client, message, args) => {
    ...
    message.delete();
    client.channels.cache.get("791685146461863956").send(`${message.guild.name} | **${message.author.tag}** -> \`${config.prefix}onepiece\``)
}

module.exports.help = {
    name: "onepiece",
    aliases: ["one_piece", "onepice", "op", "Op", "OP", "oP", "Onepiece"]
}
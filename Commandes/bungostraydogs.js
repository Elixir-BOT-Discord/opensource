...
module.exports.run = async(client, message, args) => {
    ...
    message.delete();
    client.channels.cache.get("791685146461863956").send(`${message.guild.name} | **${message.author.tag}** -> \`${config.prefix}bungostraydogs\``)
}

module.exports.help = {
    name: "bungostraydogs",
    aliases: ["Bungostraydogs", "bsd"]
}
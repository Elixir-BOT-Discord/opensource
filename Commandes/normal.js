...
const pdp=require('../Storage/normal.json')
module.exports.run = async(client, message, args) => {
    const random = util.math.random(0,927)
    ...
    message.delete();
    client.channels.cache.get("791685146461863956").send(`${message.guild.name} | **${message.author.tag}** -> \`${config.prefix}normal\``)
}


module.exports.help = {
    name: "normal",
    aliases: ["png", "jpg", "image", "pdp", "nonitro", "Normal", "PNG", "JPG"]
}
...
const pdp=require('../Storage/Packs/orange.json')
module.exports.run = async(client, message, args) => {
    const random = util.math.random(0,48)
    ...
    message.delete();
    client.channels.cache.get("791685146461863956").send(`${message.guild.name} | **${message.author.tag}** -> \`${config.prefix}orange\``)
}
module.exports.help = {
    name: "Orange",
    aliases: ["orange", "ORANGE"]
}
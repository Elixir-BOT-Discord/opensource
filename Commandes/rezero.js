...
const pdp=require('../Storage/Packs/rezero.json')
module.exports.run = async(client, message, args) => {
    ...
    message.delete();
    client.channels.cache.get("791685146461863956").send(`${message.guild.name} | **${message.author.tag}** -> \`${config.prefix}rezero\``)
}
module.exports.help = {
    name: "rezero",
    aliases: ["Rezero", "REZERO", "zero", "Zero", "ZERO", "rs", "Rs", "RS"]
}